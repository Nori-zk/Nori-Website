...
import RightLightOne from "../../../assets/Group_151.svg";
        ...
        <div className="flex flex-col lg:flex-row w-full lg:pt-6 xl:pt-4 gap-8 lg:gap-12">
          <div className="flex w-full lg:w-1/5 h-auto justify-center">
            <div className="justify-center bg-white/10 p-4 h-full rounded-xl w-full max-w-sm lg:max-w-none">
              <div className="bg-[var(--color-light-green)] text-[var(--color-very-dark-green)] py-4 px-2 rounded-xl text-sm sm:text-base md:text-base lg:text-lg 2xl:text-2xl font-light flex justify-center text-medium">
                Ethereum ↦ Mina
              </div>
              <div className="text-white py-4 px-2 rounded-xl text-sm sm:text-base md:text-base lg:text-lg 2xl:text-2xl font-light flex justify-center">
                Mina ↦ Ethereum
              </div>
            </div>
          </div>
          <div className="w-full lg:w-4/5">
            {section?.contentBlocks?.map((cb) => (
              <RichTextRenderer
                key={cb.sys.id}
                content={cb.body}
                className="text-sm sm:text-base md:text-base lg:text-lg xl:text-lg 2xl:text-2xl font-light"
              />
            ))}
          </div>
        </div>
